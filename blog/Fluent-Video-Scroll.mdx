...
wideCover: https://lms.d.zhan.com/zhanlms/addon_homework/2023/02/846314863eaf7ae27fe2/kvblurred.png
date: 2023-10-31
location: Beijing
tags: [tech]
```
...
return <div style="height: 300vh;">
  ...
  <video ref={video} src={props.src} style="max-width: 100%; width: 100%; position: sticky; top: 5rem;"></video>
</div>;
};
